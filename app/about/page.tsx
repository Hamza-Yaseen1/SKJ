...
const VALUES = [
  {
    title: "Composed in Pakistan",
    copy: "Hand-composed in small batches, from rare botanicals worked slowly and without compromise.",
  },
  {
          ...
          <Reveal className="md:pr-8">
            ...
            <div className="space-y-7 text-base leading-8 text-bark">
              <p>
                ...
                sentence sat half-finished on an atelier wall in Pakistan for
              ...
              <p>
                ...
                small to be called a product. Six compositions a year, filled
